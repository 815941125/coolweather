...
//                    Toast.makeText(ChooseAreaActivity.this,"你点了我",Toast.LENGTH_SHORT).show();
    ...
    /**
     * 查询全国所有的县，优先从数据库中查询，如果没有查询到再去服务器查询
     */
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCountiesRespomse(coolWeatherDB, response, selectedCity.getId());
                }
    ...
    public void onBackPressed() {
        if (currentLevel == LEVEL_COUNTY) {
            ...
            if (isFromWeatherActivity) {
                Intent intene = new Intent(this, WeatherActivity.class);
